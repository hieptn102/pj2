    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Ngày</label>
                 <input class="form-control example-date-input" value="{{ $date }}" name="date" type="date" value="{{ $invoice_no }}"  id="date">
            </div>
        </div>
       ...
       <div class="col-md-3">
         ...
         <div class="col-md-3">
           ...
           <div class="col-md-1">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Tồn kho(Psc/Kg)</label>
...
<!--  ---------------------------------- -->
        ...
        <tr>
            ...
            <td>
            <input type="text" name="discount_amount" id="discount_amount" class="form-control estimated_amount" placeholder="Tiền chiết khấu"  >
            </td>
        </tr>
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <select name="paid_status" id="paid_status" class="form-select">
                        ...
                        <option value="full_paid">Thanh toán đầy đủ </option>
                        <option value="full_due">Nợ </option>
                        <option value="partial_paid">Thanh toán một phần</option>

                    </select>
        <input type="text" name="paid_amount" class="form-control paid_amount" placeholder="Nhập số tiền trả" style="display:none;">
                </div>
            </div><br>
